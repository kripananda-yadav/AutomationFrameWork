...
namespace AssesmentDemoSite.Common
{
    public class LocatorsAction
    {
        ...
        public static void CLickOnWebElement(IWebDriver driver, string element,  string elementType)
        {
        ...
        public static void DropDownSelection(IWebDriver driver, string element, string value, string elementType)
        {
            if (elementType == "Id")
